...
interface FormTabPenelitianProps {
    tabPenelitian?: DataForm | undefined;
    register: UseFormRegister<ExpertQuestionnaireInterface>;
    errors: FieldErrors<ExpertQuestionnaireInterface>;
}

const FormTabPenelitian: FC<FormTabPenelitianProps> = (props) => {
    const {
        tabPenelitian,
        register,
        errors
    ...
    return (
        <div className='w-full'>
            <div className='w-full p-2'>
                <label className='font-bold text-lg'>{tabPenelitian?.name}</label>
            </div>
            {
                tabPenelitian && tabPenelitian.factor.length > 0 ? tabPenelitian.factor.map((value, index)=> {
                return(
                    <Fragment key={index}>
...
export default FormTabPenelitian